...
type Querier interface {
	...
	ResetSubtaskRetryError(ctx context.Context, id int64) (Subtask, error)
	ResetTaskRetryError(ctx context.Context, id int64) (Task, error)
	...
	UpdateSubtaskRetryError(ctx context.Context, arg UpdateSubtaskRetryErrorParams) (Subtask, error)
	...
	UpdateTaskRetryError(ctx context.Context, arg UpdateTaskRetryErrorParams) (Task, error)
